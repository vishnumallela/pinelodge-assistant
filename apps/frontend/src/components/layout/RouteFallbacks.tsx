...
export function NotFound() {
  return (
    <Centered>
      ...
      <Link
        to="/"
        className="mt-1 inline-flex h-9 select-none items-center justify-center rounded-md bg-foreground px-4 text-sm font-medium text-background transition-colors duration-150 pf-hover:bg-foreground/90 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
      >
        Back to the console
      </Link>
    </Centered>
